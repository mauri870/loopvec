...
func TestAddBuildTag(t *testing.T) {
	cases := []struct {
		name string
		src  string
		want string // expected prefix of output
	}{
		{
			name: "plain package",
			src:  "package foo\n",
			want: "//go:build !goexperiment.simd\n\npackage foo\n",
		},
		{
			name: "generated comment before package",
			src:  "// Code generated by gen. DO NOT EDIT.\n\npackage foo\n",
			want: "// Code generated by gen. DO NOT EDIT.\n\n//go:build !goexperiment.simd\n\npackage foo\n",
		},
		{
			name: "already tagged",
			src:  "//go:build !goexperiment.simd\n\npackage foo\n",
			want: "//go:build !goexperiment.simd\n\npackage foo\n",
		},
	}
	for _, tc := range cases {
		t.Run(tc.name, func(t *testing.T) {
			got := string(addBuildTag([]byte(tc.src), "!goexperiment.simd"))
			if got != tc.want {
				t.Errorf("addBuildTag:\ngot:  %q\nwant: %q", got, tc.want)
			}
		})
	}
}
