...
AddFloat32s/64-32           16.260n ± 2%   5.409n ± 2%  -66.73% (p=0.000 n=10)
AddFloat32s/4096-32         1029.0n ± 1%   258.9n ± 1%  -74.84% (p=0.000 n=10)
AddFloat32s/1048576-32      266.14µ ± 2%   91.25µ ± 3%  -65.72% (p=0.000 n=10)
MulFloat32s/64-32           13.960n ± 3%   5.323n ± 1%  -61.87% (p=0.000 n=10)
MulFloat32s/4096-32          903.7n ± 2%   257.1n ± 1%  -71.56% (p=0.000 n=10)
MulFloat32s/1048576-32      242.70µ ± 4%   94.09µ ± 4%  -61.23% (p=0.000 n=10)
ScalFloat32s/64-32          10.610n ± 3%   3.676n ± 1%  -65.35% (p=0.000 n=10)
ScalFloat32s/4096-32         745.9n ± 1%   128.5n ± 1%  -82.78% (p=0.000 n=10)
ScalFloat32s/1048576-32     190.75µ ± 1%   34.27µ ± 2%  -82.03% (p=0.000 n=10)
MixFloat32s/64-32           23.715n ± 1%   5.537n ± 2%  -76.65% (p=0.000 n=10)
MixFloat32s/4096-32         1493.0n ± 1%   254.3n ± 1%  -82.97% (p=0.000 n=10)
MixFloat32s/1048576-32      391.16µ ± 2%   96.12µ ± 3%  -75.43% (p=0.000 n=10)
AxpyFloat32s/64-32          14.205n ± 1%   5.593n ± 1%  -60.63% (p=0.000 n=10)
AxpyFloat32s/4096-32         893.4n ± 1%   262.9n ± 1%  -70.57% (p=0.000 n=10)
AxpyFloat32s/1048576-32     234.97µ ± 2%   95.23µ ± 5%  -59.47% (p=0.000 n=10)
geomean                       1.568µ        443.5n       -71.71%
```
